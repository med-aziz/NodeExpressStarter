...
import { requestAccountVerificationUseCaseBase } from '../../../usecases/auth/requestAccountVerification.usecase';
...
export const transactionalRegisterController = transactionalController((tx) => {
  ...
  return registerControllerBase(
    registerUseCaseBase({
      ...
      requestAccountVerificationUseCase: requestAccountVerificationUseCaseBase({
        usersRepo: transactionalUsersRepo,
